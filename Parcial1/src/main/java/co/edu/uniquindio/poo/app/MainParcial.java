    ...
    public static void main(String[] args){
        ...
        do{
            ...
            switch (opcion){
                ...
                case 4: char[][] matriz = hotel.crearMatrizOcupacion();
                ...
                case 5: JOptionPane.showMessageDialog(null, obtenerReservasEspeciales(hotel));
                    break;

                case 6: byte fecha = Byte.valueOf(JOptionPane.showInputDialog(null, "Ingresa la fecha a consultar (1 lunes ... 7 domingo): "));
                    JOptionPane.showMessageDialog(null, obtenerIngresosHotel(hotel, fecha));
                    break;

                case 7: JOptionPane.showMessageDialog(null, obtenerDisponibilidadHabitaciones(hotel));
                    break;

                case 8: JOptionPane.showMessageDialog(null, "Gracias por usar la plataforma.");
                    break;
